...
This repository contains the Lean formalization of the Proposition 3 of [_Global optimization of Lipschitz functions, Malherbe C. and Vayatis N., 2017_](https://proceedings.mlr.press/v70/malherbe17a/malherbe17a.pdf) and is associated the the paper [_A Unifying Framework for Global Optimization: From Theory to Formalization_](https://arxiv.org/abs/2508.20671). It uses [LeanGO](https://github.com/gaetanserre/LeanGO) for a formal definition of global optimization algorithms.
